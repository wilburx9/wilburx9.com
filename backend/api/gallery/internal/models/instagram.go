...
type InstaToken struct {
	Value       string    `json:"access_token" firestore:"value" mapstructure:"value"`
	ExpiresIn   int64     `json:"expires_in" firestore:"expires_in" mapstructure:"expires_in"`
	RefreshedAt time.Time `json:"refreshed_at" firestore:"refreshed_at" mapstructure:"refreshed_at"`
}
